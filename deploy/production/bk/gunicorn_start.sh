...
DJANGODIR=/www/var/$NAME/$NAME                      	# Django project directory
VENVDIR=/www/var/$NAME/VENV_NAME                		# Django project directory
SOCKFILE=/www/var/$NAME/$VENV_NAME/run/gunicorn.sock    # we will communicte using this unix socket
